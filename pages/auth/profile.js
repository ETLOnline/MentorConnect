...
export default function Profile() {
  ...
  function submitHandler(event) {
    ...
    const enteredInterest = inputInterest.current.value;
    const enteredLearning = inputLearning.current.value;
                      ...
                      <div className="col-span-3 sm:col-span-2">
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                          <input
                            ...
                            placeholder="Please enter your interest by( , )seprated"
                            ref={inputInterest}
                          />
                        </div>
                      </div>
                      ...
                      <div className="col-span-3 sm:col-span-2">
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                          <input
                            ...
                            ref={inputLearning}
                            className="block w-full h-9 flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            placeholder="Please enter your learning by( , )seprated"
                          />
                        </div>
                      </div>
                    </div>
