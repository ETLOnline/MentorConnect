      ...
      <div className="px-6 md:px-10 py-6 md:py-10 font-montserrat">
        ...
        <div className="grid md:grid-cols-3 gap-6 bg-white">
          ...
          <div className="md:col-span-2 rounded-md shadow">
            <div className="py-8">
              <h2 className="text-lg md:text-xl xl:text-3xl font-bold text-text text-center">Create Session</h2>
              <p className="text-center text-text text-base">Fill out the form to create a session</p>
            </div>
