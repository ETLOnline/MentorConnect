    ...
    return(
        ...
        <div className="flex justify-between mx-4 mt-4">
            <div className="w-[40.2%] flex gap-2 items-center">
                ...
                <p className=" w-[79.73%] overflow-hidden text-[87.5%] flex leading-[16px] font-bold text-center text-[#1C2D56]">Everything Design</p>
            </div>
        ...
        “I learnt so much about design in this session, I totally reccomend this to everyone.”
        </div>
