        ...
        <>
          <div>
            <div className="flex justify-between mb-[40px] mt-[64px]">
                <div>
                    <h1 className="text-[#1C2D56] text-[24px] font-bold leading-[28px]">Skill Ratings</h1>
                </div>
                <div>
                    <input type="search" Placeholder="Skill Name" className="border-[1px] rounded-[8px]"></input>
                </div>
            </div>
